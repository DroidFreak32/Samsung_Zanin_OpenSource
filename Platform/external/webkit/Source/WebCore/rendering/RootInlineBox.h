...
//SISO HTMLComposer Start
    void setLineHeightAdjust(bool adjustHeight) {m_lineHeightAdjust = adjustHeight;}
    bool isLineHeightAdjust() const {return m_lineHeightAdjust;}
    int lineHeightAdjustValue() const {return m_lineHeightAdjustValue;}
...
//SISO HTMLComposer Start
    //For Thai vowel height adjust (Descent values of FontMetrics not matching with actual height)
    bool m_lineHeightAdjust;
    int m_lineHeightAdjustValue;
//SISO HTMLComposer End
