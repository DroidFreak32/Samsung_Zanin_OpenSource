...
// SAMSUNG CHANGE : chnage max_sockets_per_group(will be determined by CscFeature
//int csc_max_sockets_per_group = SecNativeFeature::getInstance()->getInteger(CscFeature_Web_MaxConnectionPerHost);
//int g_max_sockets_per_group = (csc_max_sockets_per_group > 0)?csc_max_sockets_per_group:18;
int g_max_sockets_per_group = 18;
