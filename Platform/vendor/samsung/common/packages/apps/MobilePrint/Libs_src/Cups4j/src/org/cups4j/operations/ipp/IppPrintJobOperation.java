...
public class IppPrintJobOperation extends IppOperation {
   ...
   *          -format,document-natural-language,job-k-octets,job-impressions ,job-media-sheets,
  ...
  public ByteBuffer getIppHeader(URL url, Map<String, String> map) throws UnsupportedEncodingException {
    if (url == null) {
    	Log.d("cups4j", "IppPrintJobOperation.getIppHeader(): uri is null");
      return null;
    }
  ...
  private static ByteBuffer getJobAttributes(ByteBuffer ippBuf, String[] attributeBlocks)
      throws UnsupportedEncodingException {
    if (ippBuf == null) {
    	Log.d("cups4j", "IppPrintJobOperation.getJobAttributes(): ippBuf is null");
      return null;
    }
