...
static u16 adc_weight_section_discharge[]       = {5000, 3500, 2000,  600,  260,  220,  115,  112,  280,  450,  420,  600,  790,  900};
...
static int d2083_read_voltage(struct d2083_battery *pbat)
{
	...
	{			
		...
		//offset += 5;
		pr_info("[L%d] %s. Charging offset is %d \n", __LINE__, __func__, offset);
...
re_measure:
	sum = 0; read_adc = 0;
	pr_info("[L%4d] %s function is called\n", __LINE__, __func__);
	for(i = 4; i; i--) {
